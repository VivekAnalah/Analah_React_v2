...
export const Alert =({title, type,message}) => {
  ...
  return (
    <div className="flex justify-end items-center h-screen w-[500px]">
        ...
        <div className="relative alert bg-gray-200 p-4 rounded-lg shadow-md">
          ...
          <div className="relative mt-2">
            <div className="h-2 bg-gray-300 rounded-full overflow-hidden">
              <div   className={type === 'success' ? "mb-4 rounded-lg bg-green-100 px-6 py-5 text-base text-green-700 absolute top-20 right-10": "mb-4 rounded-lg bg-red-100 px-6 py-5 text-base text-red-700 absolute top-20 right-10"}
